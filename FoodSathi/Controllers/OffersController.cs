...
namespace FoodSathi.Controllers
{
    public class OffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Discount,StartDate,EndDate,ImageUrl")] Offer offer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Discount,StartDate,EndDate,ImageUrl")] Offer offer)
        {
            if (id != offer.Id)
            {
                return NotFound();
