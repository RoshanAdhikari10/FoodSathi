...
app.UseStaticFiles(); // ✅ Add this for serving CSS, JS, Images, etc.

app.UseRouting();

app.UseAuthentication(); // ✅ Make sure authentication runs before authorization
